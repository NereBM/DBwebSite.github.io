		...
		<div style="overflow-x:auto;">
			<table class="table table-bordered" style=" margin-top: 1%; background-color: white">
				...
				<tbody>
					...
					<?php
						$sql="SELECT module.moduleID, title, credits, term FROM student,EnroleIn,module WHERE student.studentID = EnroleIn.studentID AND module.moduleID = EnroleIn.moduleID AND student.studentID = ".$studentid;
						...
						if($result->num_rows>0){
							...
							echo '<tr>';
								...
								echo '<td>'.$row['term'].'</td>';
								echo ' <td class="tg-s6z2"> <a href="https://www.w3schools.com/html/html_tables.asp">See details</a></td>';
							echo '</tr>';
